...
import style from './RecipeSkeletonCard.module.scss';

type RecipeSkeletonCardProps = {
  className?: string;
};

const RecipeSkeletonCard: FC<RecipeSkeletonCardProps> = ({ className }) => {
  return (
...
export default memo(RecipeSkeletonCard);
